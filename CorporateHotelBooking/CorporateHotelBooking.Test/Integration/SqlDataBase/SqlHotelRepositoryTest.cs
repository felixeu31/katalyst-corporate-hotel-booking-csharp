...
public class SqlHotelRepositoryTest
{
    ...
    //    var employee1 = new Hotel();

    //    // Act
    //    _employeeRepository.Add(employee1);

    //    // Assert
    //    HotelData? employee = context.Hotels.Find(employee1.HotelId.Value);
    //    employee.Should().NotBeNull();
    //    employee.HotelId.Should().Be(employee1.HotelId.Value);
    ...
    //    // Arrange
    //    var context = new CorporateHotelDbContext(_fixture.DbContextOptions);
    //    var employeeData = new HotelData
    //    {
    //        HotelId = Guid.NewGuid(),
    //        CompanyId = Guid.NewGuid()
    //    };
    //    context.Hotels.Add(employeeData);
    //    context.SaveChanges();

    //    // Act
    //    _employeeRepository.Delete(HotelId.From(employeeData.HotelId));

    //    // Assert
    //    context.Hotels.Should().NotContain(employeeData);
    //}
    ...
    //    // Act
    //    var employee = _employeeRepository.Get(HotelId.From(employeeData.HotelId));

    //    // Assert
    //    employee.Should().NotBeNull();
    //    employee.HotelId.Should().Be(HotelId.From(employeeData.HotelId));
